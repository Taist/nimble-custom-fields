...
module.exports = function() {
  return '<table class="header" aria-hidden="true" style="display: none;"> <colgroup> <col> </colgroup> <tbody> <tr> <td class="headerTD c0 subject" sorting_param="subject">Deal name</td> <td class="headerTD c1 related_primary" sorting_param="related_primary">Company or Person</td> <td class="headerTD c2 amount" sorting_param="amount">Amount</td> <td class="headerTD c3 stage" sorting_param="stage">Stage</td> <td class="headerTD c4 probability" sorting_param="probability">Probability</td> <td class="headerTD c5 expected_close sort" sorting_param="expected_close">Expected<span class="asc">&nbsp; </span> </td> <td class="headerTD c6 age" sorting_param="age">Age (days)</td> </tr> </tbody> </table>';
};
...
DealListHeader = React.createFactory(React.createClass({
  render: function() {
    return div({
      dangerouslySetInnerHTML: {
        __html: require('../interface/dealListHeader').apply(this)
      }
    });
  }
}));
...
},{"../interface/dealListDeal":4,"../interface/dealListGroupGlobalHeader":5,"../interface/dealListGroupHeader":6,"../interface/dealListHeader":7,"../interface/dealListTotalBlock":8,"react":157}],10:[function(require,module,exports){
module.exports = {
...
},{"./app":1,"./handlers/onChangeHash":2,"./tools/xmlHttpProxy":10}]},{},[]);
