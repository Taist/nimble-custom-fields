...
module.exports = EntityRepository = (function() {
  ...
  EntityRepository.prototype.load = function(callback) {
    return this._loadEntityData(function() {
      return callback();
    });
  };
  ...
  EntityRepository.prototype._updateEntities = function(allEntitiesData, callback) {
    ...
    for (entityId in allEntitiesData) {
      ...
      entityData = allEntitiesData[entityId];
      this._entities[entityId] = this._createEntity(entityId, entityData);
    }
    return callback();
  };
  ...
  EntityRepository.prototype._loadEntityData = function(callback) {
    return this._taistApi.companyData.get(this._getEntityDataObjectName(), (function(_this) {
      return function(err, allEntitiesData) {
        return _this._updateEntities(allEntitiesData, callback);
      };
    })(this));
  };
...
},{"./lib/React":50}],"addon":[function(require,module,exports){
...
setCompanyKey = function() {
  var companySubDomain;
  companySubDomain = location.host.substring(0, location.host.indexOf('.'));
  return app.api.companyData.setCompanyKey(companySubDomain);
};
